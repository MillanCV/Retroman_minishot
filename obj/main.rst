...
Hexadecimal [16-Bits]
                             ...
                             13 
                     0038    14 SP_PLAYER_SHIP_W = 56 
                     0014    15 SP_PLAYER_SHIP_H = 20
                             16 
   4530                      17 _main::
   4530 CD 28 46      [17]   18     call cpct_disableFirmware_asm
                             19 
   4533 0E 00         [ 7]   20     ld      c, #0   ;;  c = 0;
   4535 CD 1B 46      [17]   21     call    cpct_setVideoMode_asm
                             22 
   4538 21 20 45      [10]   23     ld      hl, #_g_palette
   453B 11 10 00      [10]   24     ld      de, #16
   453E CD 5E 45      [17]   25     call    cpct_setPalette_asm
   0011                      26     cpctm_setBorder_asm HW_BLACK
                              1    .radix h
   ...
   4541 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   4544 CD 71 45      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
                             27 
   4547 11 00 C0      [10]   28     ld      de, #CPCT_VMEM_START_ASM
   454A 06 64         [ 7]   29     ld      b, #100
   454C 0E 28         [ 7]   30     ld      c, #40
   454E CD 39 46      [17]   31     call    cpct_getScreenPtr_asm    
                             32     ;; HL = pvmem
                             33 
   4551 EB            [ 4]   34     ex      de, hl                  ;; DE = pvmem
   4552 21 00 40      [10]   35     ld      hl, #_sp_player_ship
                             36     
   4555 06 38         [ 7]   37     ld      b, #SP_PLAYER_SHIP_W
   4557 0E 14         [ 7]   38     ld      c, #SP_PLAYER_SHIP_H
   4559 CD 7B 45      [17]   39     call    cpct_drawSprite_asm
                             40 
   455C                      41 loop:
   455C 18 FE         [12]   42     jr  loop
